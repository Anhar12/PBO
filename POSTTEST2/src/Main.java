...
public class Main {
    ...
    static void display_game(){
        ...
        System.out.println("===================================================");
        for (int i = 0 ; i < dataGame.size() ; i++){
            int jarak = dataGame.get(i).get_game().length()/2;
            System.out.print("  [" + (i+1) + "]");
            geser(20-jarak);
            System.out.println(dataGame.get(i).get_game());
            System.out.println("---------------------------------------------------");
                                ...
                                while (loop_edit) {
                                    ...
                                    switch(pilih){
                                        ...
                                        while (true){
                                            ...
                                            if (cek_game(game_edit) == true){
                                                dataGame.get(i).set_game(game_edit);
                                    ...
                                    case "2":
                                        ...
                                        if (dataGame.get(i).cek_variasi(cari_edit) == true){
                                            ...
                                            dataGame.get(i).set_topUp(data_edit, dataGame.get(i).idx_variasi(cari_edit));;
                                        } else {
                                            ...
                                            if (cek_game(game) == true){
                                                ...
                                                while (edit_variasi){
                                                    ...
                                                    while (true){
                                                        System.out.print("\nTambah Variasi Top Up Lagi [Y/N] ? "); String ulang = br.readLine();
                                                        if (ulang.equalsIgnoreCase("n") || ulang.equalsIgnoreCase("N")){
                                                            dataGame.get(i).update(game, data_edit, mataUang);
                                                            edit_variasi = false;
                                                            System.out.print("\nData Berhasil Diedit! Tekan ENTER Untuk Melanjutkan..."); gtc = br.readLine();
                                                            break;
                                                        } else if (ulang.equalsIgnoreCase("y") || ulang.equalsIgnoreCase("Y")){
